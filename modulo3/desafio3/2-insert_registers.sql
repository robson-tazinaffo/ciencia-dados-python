...
INSERT INTO Pedido (status, descricao, pessoa, tipo_pedido, frete, Entrega_idEntrega, valor_pedido, valor_total, status_pedido) VALUES (2, 'Venda', 1, 1, 12.00, 1, 150.50, 162.50, 1);

  

INSERT INTO pedido_entrega (id_pedido, previsao, status, data_status, cod_rastreio) VALUES (1, '2022-10-25', 'Aguardando separação', now(), '123456789' );
