...
CREATE TABLE IF NOT EXISTS `oficina`.`Veiculo` (
  ...
  INDEX `fk_Veiculo_OrdemServico1_idx` (`idOrdem_Servico` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Veiculo_OrdemServico1`
    ...
    REFERENCES `oficina`.`ordem_servico` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `oficina`.`Produto` (
  ...
  PRIMARY KEY (`id`, `fornecedor_idfornecedor`),
